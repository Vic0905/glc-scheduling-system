                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-slate-100">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">English Name</th>
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            @forelse($students as $student)
                                <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-800">{{ $student->english_name }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-800">{{ $student->course }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-800">{{ $student->level }}</td>
