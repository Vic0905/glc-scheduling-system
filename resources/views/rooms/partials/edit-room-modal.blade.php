<div id="editRoomModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden opacity-0 transition-opacity duration-300">
    <div class="dark:bg-gray-900 bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-lg mx-4 transform scale-95 transition-all duration-300">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold dark:text-gray-100 text-gray-800">Edit Room</h2>
        ...
        <form id="editRoomForm" method="POST" action="" class="space-y-5">
            ...
            <!-- Room Name Input -->
            <div>
                <label for="modalRoomName" class="block text-sm font-medium dark:text-gray-100 text-gray-700 mb-1">Room Name</label>
                <input
                    type="text"
                    name="roomname"
                    id="modalRoomName"
                    class="w-full px-4 py-2 border dark:bg-gray-900 border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                    required
                >
            </div>
