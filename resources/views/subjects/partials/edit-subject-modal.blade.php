...
<!-- Edit Subject Modal -->
<div id="editSubjectModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden opacity-0 transition-opacity duration-300">
    <div class="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-lg mx-4 transform scale-95 transition-all duration-300">
        <!-- Header -->
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-gray-800" id="editModalTitle">Edit Subject</h2>
        ...
        <!-- Form -->
        <form id="editSubjectForm" method="POST" action="" class="space-y-5">
            @csrf
            @method('PATCH')

            <!-- Subject Name -->
            <div>
                <label for="modalSubjectName" class="block text-sm font-medium text-gray-700 mb-1">Subject Name</label>
                <input
                    type="text"
                    name="subjectname"
                    id="modalSubjectName"
