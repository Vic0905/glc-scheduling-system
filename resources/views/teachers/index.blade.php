<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
            ...
            <!-- Teachers Table -->
            <div class="bg-white dark:bg-gray-800 shadow-lg sm:rounded-lg overflow-x-auto max-w-auto rounded-lg max-h-[500px] overflow-y-auto text-sm">
                <div class="min-w-full inline-block">
                    <table class="min-w-full table-auto border-collapse border border-gray-300 dark:border-gray-700">
                        <thead class="bg-slate-100 dark:bg-gray-700 text-gray-900 dark:text-white sticky top-0 z-10">
                            <tr>
