<div id="editteacherModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden opacity-0 transition-opacity duration-300">
    <div class="dark:bg-gray-900 bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-lg mx-4 transform scale-95 transition-all duration-300">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold dark:text-gray-100 text-gray-800">Edit Teacher</h2>
        ...
        <form id="editTeacherForm" method="POST" action="" class="space-y-5">
            ...
            <!-- Teacher Name -->
            <div>
                <label for="modalName" class="block text-sm font-medium dark:text-gray-100 text-gray-700 mb-1">Teacher Name</label>
                <input
                    type="text"
                    name="name"
                    id="modalName"
            ...
            <!-- Nickname -->
            <div>
                <label for="modalNickname" class="block text-sm font-medium dark:text-gray-100 text-gray-700 mb-1">Nickname</label>
                <input
                    type="text"
                    name="nickname"
                    id="modalNickname"
