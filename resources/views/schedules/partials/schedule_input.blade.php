                    ...
                    @foreach ($rooms as $room)
                        ...
                        @if ($groupedByTeacherAndDate->isEmpty())
                            <tr>
                                ...
                                <td class="px-4 py-3 border border-gray-200 dark:border-gray-700 font-bold text-gray-800 dark:text-gray-200">{{ $room->roomname }}</td>
                                @foreach(['08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00'] as $time)
                                    @php
                                        $endTime = \Carbon\Carbon::createFromFormat('H:i', $time)->addMinutes(50)->format('H:i');
                                        $timeSlotValue = "{$time}-{$endTime}";
                                    @endphp
                                    <td class="px-1 py-2 border border-gray-200 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-300">
                                        <div class="schedule-cell" data-room-id="{{ $room->id }}" data-time-slot="{{ $time }}">
                                            ...
                                            <div class="hidden mt-1">
                                                <form class="schedule-form" data-room-id="{{ $room->id }}" data-time-slot="{{ $time }}">
                                                    ...
                                                    {{-- Selects --}}
                                                    <select name="sub_teacher_id" class="block w-full text-xs py-1 px-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
